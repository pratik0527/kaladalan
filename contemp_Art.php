<html>
    ...
    <body>
        ...
        ?>
        <br><br><br><br><br>
        <h1 style="text-align: center">Contemporey Art</h1>
        <br>
        <div class="container">
        ...
        $sql=mysqli_query($con,"SELECT * FROM `Contemporey_Art`");
        ...
        ?>
                    <li class="col-md-6 col-sm-6">
                        <figure>
                            <div><a href="admin/imagess/<?php echo $data['image'];?> "><img src="admin/imagess/<?php echo $data['image'];?> " alt="image" width="600px" height="300px"></a></div>
                            <figcaption>
                                ...
                                <div class="modal-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="number" placeholder="Enter Your Number" name="number">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="name">Painting Name</label>
                                            <input type="email" class="form-control" id="paintingname" placeholder="Enter Your PaintingName" name="paintingname">
                                        </div>
