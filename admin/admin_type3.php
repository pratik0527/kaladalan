...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- //header-ends -->
        ...
        <div class="container">
            <div class="type1" style="margin-left: 20%; background-color: #f1f1f1; height: auto; width:80% ; padding: 50px">
                
                <h1 style="text-">Contemporery Art</h1>
                <br>
                
                <a href="new_type3.php" target="f1" class="btn btn-success" role="button" style="float: right">New Painting</a>
                <br><br><br>
                ...
                $result = mysqli_query($con,"SELECT * FROM Contemporey_Art");
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "<td> <img src='pic/".$row["image"]." style='width:20%'> <td>";
                    echo "</tr>";
                }
                echo "</table>";
