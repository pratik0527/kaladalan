            ...
            <div class="left-side-inner">
                ...
                <!--sidebar nav start-->
                    ...
                    <ul class="nav nav-pills nav-stacked custom-nav">
                       ...
                       <li class="active"><a href="order.php.php"><i class="lnr lnr-power-switch"></i><span>Order Request</span></a></li>
    ...
    <!-- //header-ends -->
        ...
        <!-- data register -->
                ...
                if(isset($_POST['upload']))
                {
                    ...
                    $pic= $_FILES['pic']['name'];
                    $path="admin/imagess/".$pic;
                    $sql="INSERT INTO `phad_painting`(`heading`, `description`, `image`) VALUES ('".$heading."','".$description."','".$pic."')";
