    ...
    <!-- //header-ends -->
       ...
       <div class="container">
            <div class="type1" style="margin-left: 20%; background-color: #f1f1f1; height: auto; width:80% ; padding: 50px">
                ...
                <h1 style="text-">Mixed Media Painting</h1>
                <br>
                
                <a href="new_type4.php" target="f1" class="btn btn-success" role="button" style="float: right">New Painting</a>
                <br><br><br>
                ...
                $result = mysqli_query($con,"SELECT * FROM mixed");
