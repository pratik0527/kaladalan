    ...
    <!-- main content start-->
        ...
        <div class="container">
            <div class="passchange">
                <br><h1 style="text-align: center">Order Request</h1>
                <?php
                
                    include('connect.php');
                
                $result = mysqli_query($con,"SELECT * FROM enquiry");
                
                echo "<table border='1 style='margin-left: 20%' class='table table-striped'>
                <tr>
                <th>Name</th>
                <th>Email</th>
                <th>Number</th>
